...
class FakeFoodRepository {
    private val frenchToasts = Recipe("Французские тосты с клубникой", Meals.BREAKFAST,Dishes.DESSERT ,linkedSetOf(),15,450,linkedSetOf(),true,3,"drawable/ic_french_toasts.png",2)
    private val toastsWithCinnamon = Recipe("Тосты с корицей и сахаром", Meals.BREAKFAST,Dishes.DESSERT ,linkedSetOf(),15,350,linkedSetOf(),false,5,"drawable/ic_toasts_with_cinnamon.png",3)
    private val blueberryMuffins = Recipe("Черничные маффины", Meals.BRUNCH,Dishes.SNACK,linkedSetOf(),45,210,linkedSetOf(),false,2,"drawable/ic_maffin.png",7)
    val glazedSalmon = Recipe("Ласось в глазури", Meals.DINNER, Dishes.MAIN_COURSE,linkedSetOf(),60,300,linkedSetOf(),true,4,"drawable/ic_glazed_salmon.png",1)
    private val asianGlazedChicken = Recipe("Asian Glazed Chicken Things",Meals.LUNCH,Dishes.MEAT_DISH, linkedSetOf(),90,500,linkedSetOf(),false,1,"drawable/ic_azia_glazet_chiken.png",5)
