...
data class Recipe(val number:Int,val name: String, val meals: Meals,val typeOfDish:Dishes, val indigrients: ArrayList<Ingredient>, val time:Long, val cal:Int, val listOfSteps:ArrayList<String>, val isLike:Boolean, val stars: Float, val imgLinks:String, val countServings:Int) {
    var id =number
    var title = name
    var category = meals
